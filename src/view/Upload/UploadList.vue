<template>
	<div class="upload-list">
		...
		<div class="ul-list-view">
			<n-scrollbar>
				<div
						class="ul-item flex-alc"
						v-for="item in props.fileList"
						:key="item.id"
				>
					<n-icon
							:size="34"
							:component="item.imgUrl === '' ? FileTextOutlined : FileImageOutlined"
					></n-icon>
						...
						<template #trigger>
							...
							>
								<template #icon>
									<n-icon
											size="16"
											:component="ArrowClockwise20Filled"
									/>
								</template>
							</n-button>
						</template>
					...
					<n-tooltip trigger="hover">
						<template #trigger>
							<n-button
									text
									@click="emit('delFile', item.id)"
							>
								<template #icon>
									<n-icon
											size="16"
											:component="DeleteDismiss24Regular"
									/>
								</template>
							</n-button>
						</template>

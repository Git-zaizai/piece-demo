...
onMounted(() => {
    loader.init().then(monaco => {
        monaco.editor.create(document.querySelector('#monacoEditor-loader'), {
...
<template>
    <div class="flex-alc-juc">
        <h1>monacoEditor-loader.vue</h1>
        <div class="monaco-editor-view">
            <div id="monacoEditor-loader"></div>
        </div>
    </div>
</template>
<style scoped>
...
#monacoEditor-loader :deep(.monaco-editor, .monaco-editor .margin, .monaco-editor-background) {
    background-color: var(--n-color);
}

#monacoEditor-loader :deep(.monaco-editor .margin) {
    background-color: var(--n-color);
}

#monacoEditor-loader :deep(.monaco-editor-background) {
    background-color: var(--n-color);
}
</style>
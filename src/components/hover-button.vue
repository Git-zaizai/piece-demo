<template>
  <div>
    <n-popover scrollable arrowPointToCenter trigger="click" displayDirective="show" placement="top-end"
      style="width: 288px;height: calc(100vh - 200px);padding: 0;">
      <template #trigger>
        <n-el class="hover-button">
...
<script name="HoverButton" lang="ts" setup>
